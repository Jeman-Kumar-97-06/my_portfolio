    ...
    return (
        <div className='home_page'>
                ...
                <div className='projects'>
                    <div className='project_each'>
                        ...
                        <div className='content'>
                            <a href='#'><h4>Wallpaper App <span class="material-symbols-outlined">link</span></h4></a>
                    ...
                    <div className='project_each'>
                        ...
                        <div className='content'>
                            <a href='#'><h4>ToDoList App <span class="material-symbols-outlined">link</span></h4></a>
                            <p>HTML+CSS+JS+React+NodeJS+MongoDB+JWT</p>
                        </div>
                    </div>
                    <div className='project_each'>
                        ...
                        <div className='content'>
                            <a href='#'><h4>Workout Tracker App <span class="material-symbols-outlined">link</span></h4></a>
                            <p>HTML+CSS+JS+React+NodeJS+MongoDB+JWT</p>
                        </div>
                    </div>
                    <div className='project_each'>
                        ...
                        <div className='content'>
                            <a href='#'><h4>Notes App <span class="material-symbols-outlined link_icon">link</span></h4></a>
                            <p>HTML+CSS+JS+React+NodeJS+MongoDB+JWT</p>
                        </div>
                    </div>
                </div>
            ...
            <div className='links'>
                ...
                <a href='https://www.udemy.com/certificate/UC-d0914537-adbb-40c6-81f5-f1f03898a7ed/'>Full Stack Web Development <span class="material-symbols-outlined">link</span></a>
            </div>
